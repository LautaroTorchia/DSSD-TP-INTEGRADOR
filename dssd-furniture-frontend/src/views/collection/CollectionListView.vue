...
<template>
  ...
  <div v-else class="container mt-4">
    <div class="mb-3 d-flex justify-content-end">
      <router-link :to="{ name: 'collection-create' }" class="btn btn-primary"
        >Crear colección</router-link
      >
    </div>
        ...
        <template v-if="orderedCollections.length">
          ...
          >
            ...
            >
              ...
              <td>
                <router-link
                  :to="`/${collection.id}/furniture`"
                  class="btn btn-dark btn-sm"
                  >Ver Muebles</router-link
                >
                <button
                ...
                <button
                  v-if="!collection.designed"
                  @click="finishCollection(collection)"
