<template>
    ...
    <div :style="{ visibility: hiddenVisibility }">
        <div class="chart-container" style="position: relative; height:40vh; width:30vw">
            <h4 class="text-center">Tiempo promedio de planeamiento: {{ averagePlanTime }} dias</h4>
...
onMounted(async () => {
    ...
    const designTimeList = await getArchivedTasks(filteredCollections, "Diseñar coleccion")
    const fabricationOrderList = await getArchivedTasks(filteredCollections, "Reservar espacio de fabricación")
