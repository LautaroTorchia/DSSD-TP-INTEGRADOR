  ...
  <div :style="{ visibility: hiddenVisibility }">
    ...
    >
      <h4 class="text-center">
        Tiempo promedio de diseño: {{ averageDesignTime }} dias
      </h4>
...
onMounted(async () => {
  ...
  let designTimeList = await getArchivedTasks(
    filteredCollections,
    "Diseñar coleccion",
  );
  ...
  averageDesignTime.value =
    designTimeList.reduce((sum, designTime) => sum + designTime.designTime, 0) /
    designTimeList.length;
