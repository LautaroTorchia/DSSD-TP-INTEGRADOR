...
import { router, fetchWrapper, advanceNamedBonitaTaskWithCollection } from '@/helpers'
...
const postDistributions = async (lots) => {
    ...
    lots.forEach(lot => {
        ...
        distpost = fetchWrapper.post(`${baseUrl}/entregas/distribucion-de-lote/`, distribution)
    })
    await distpost
}
...
const submitForm = async () => {
    ...
    await advanceNamedBonitaTaskWithCollection(collectionId, "Distribuir colección")
