            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div v-if="estimatedLaunchDate && slot_start_date" class="date-field form-group">
                        ...
                        <input type="date" id="slot_end_date" v-model="slot_end_date" class="form-control" 
                        :min="slot_start_date" :max="estimatedLaunchDate"/>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div v-for="material in collectionMaterialList" :key="material.id">
                        ...
                        <div class="card-text">
                            <div v-for="materialFromProvider in materialsFromProviders"
                                            ...
                                            <div class="form-check">
                                                ...
                                                <div v-if="materialFromProvider.checked">
                                                    ...
                                                    <div v-if="!validateDeliveryDate(materialFromProvider)">
                                                        <p class="text-danger">Delivery date is required for selected
                                                            material
                                                        </p>
                                                    </div>
                                                </div>
                ...
                <div v-if="!validateAllMaterials()">
                    <p class="text-danger text-center">Total amount for each material must be equal to the amount of the
                        material</p>
                </div>
            </div>
...
const fetchMaterialsFromProviders = async () => {
    ...
    if (!materialsQuery) {
        materialsQuery = await fetchWrapper.get(`${proveedoresUrl}/proveedores/proveedores-materiales/`)
    } else {
