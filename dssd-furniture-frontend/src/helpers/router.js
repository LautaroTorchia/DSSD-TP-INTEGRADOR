...
import {
  ...
  FurnitureCreate,
  FurnitureDetail,
  DesignedCollectionList,
  MaterialAnalysis,
  FabricationPlan,
  FabricationPlanConfirm,
  Dashboard,
  DeliveryOrderList,
  MaterialControl,
  DeliveryOrderCreate,
  FabricationControlList,
  Renegociate,
  DistributionList,
  DistributionCreate,
  AssociateLotsList,
...
export const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/:collection/furniture/create",
      component: FurnitureCreate,
      name: "furniture-create",
      meta: { roles: ["designer", "admin"] },
    },
    {
      path: "/:collection/furniture/:id",
    ...
    {
      path: "/designed-collections",
      component: DesignedCollectionList,
      name: "designed-collections",
      meta: { roles: ["operations_analist", "admin"] },
    },
    {
      path: "/:collection/material-analysis",
      component: MaterialAnalysis,
      name: "material-analysis",
      meta: { roles: ["operations_analist", "admin"] },
    },
    {
      path: "/:collection/fabrication-plan",
      component: FabricationPlan,
      name: "fabrication-plan",
      meta: { roles: ["operations_analist", "admin"] },
    },
    {
      path: "/:collection/fabrication-plan-confirm",
      component: FabricationPlanConfirm,
      name: "fabrication-plan-confirm",
      meta: { roles: ["operations_analist", "admin"] },
    },
    {
      path: "/:collection/material-control",
      component: MaterialControl,
      name: "material-control-list",
      meta: { roles: ["operations_analist", "admin"] },
    },
    {
      path: "/:collection/renegociate",
      component: Renegociate,
      name: "renegociate-collection",
      meta: { roles: ["operations_analist", "admin"] },
    },
    {
    ...
    {
      path: "/:collection/distribution-create",
    ...
    {
      path: "/fabrication-control-list",
      component: FabricationControlList,
      name: "fabrication-control-list",
      meta: { roles: ["factory_liason", "admin"] },
    },
    {
      path: "/:collection/fabrication-control",
      component: FabricationControl,
      name: "fabrication-control",
      meta: { roles: ["factory_liason", "admin"] },
    },

    {
      path: "/delivery-order-collection-list",
      component: DeliveryOrderList,
      name: "delivery-order-collection-list",
      meta: { roles: ["commercial_analist", "admin"] },
    },
    {
      path: "/:collection/delivery-order-create",
      component: DeliveryOrderCreate,
      name: "delivery-order-create",
      meta: { roles: ["commercial_analist", "admin"] },
    },
    {
      path: "/associate-lots-list",
      component: AssociateLotsList,
      name: "associate-lots-list",
      meta: { roles: ["commercial_analist", "admin"] },
    },
    {
      path: "/:collection/associate-lots",
      component: AssociateLots,
      name: "associate-lots",
      meta: { roles: ["commercial_analist", "admin"] },
    },
  ],
  ...
  if (authRequired) {
    try {
      ...
      const matchingRoles = response.filter(
        (role) => role.username === storedUsername,
      );
      const hasAllowedRole = matchingRoles.some((role) =>
        allowedRoles.includes(role.role_denomination),
      );
      if (hasAllowedRole) {
        return next();
      } else {
